<?php if (APH\Roles::userHas([APH\Roles::EOT, APH\Roles::NET], $current_user)) : ?>
		<a href="javascript:;" role="button" class="btn" data-micromodal-trigger="invite-shopper">Invite Shopper</a>
		<?php
			$modal_state = '';
