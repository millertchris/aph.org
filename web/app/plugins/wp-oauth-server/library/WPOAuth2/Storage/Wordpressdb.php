...
class Wordpressdb implements
	...
	public function getUserClaims( $user_id, $claims ) {
		...
		if ( in_array( 'email', $claims ) ) {
			...
			$userClaims = apply_filters( 'wo_userclaims_email', $userClaims, $user_id );
		}
		...
		if ( in_array( 'profile', $claims ) ) {
			$userClaims += array(
				...
				'profile'            => '',
				'picture'            => get_avatar_url( $userInfo->user_email ),
			...
			$userClaims = apply_filters( 'wo_userclaims_profile', $userClaims, $user_id );
		}
		...
		if ( in_array( 'address', $claims ) ) {
			...
			$userClaims = apply_filters( 'wo_userclaims_address', $userClaims, $user_id );
		}
		...
		if ( in_array( 'phone', $claims ) ) {
			...
			$userClaims = apply_filters( 'wo_userclaims_phone', $userClaims, $user_id );
		}

		return apply_filters( 'wo_userclaims', $userClaims, $user_id );
	}
