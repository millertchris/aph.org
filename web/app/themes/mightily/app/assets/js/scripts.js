  ...
  function Anchors (Glide, Components, Events) {
    ...
    var Anchors = {
      ...
      click: function click(event) {
        // Don't interfere with wishlist buttons
        if (event.target && (
          event.target.classList.contains('wl-add-to') ||
          event.target.classList.contains('wl-add-to-single') ||
          event.target.closest('.wl-add-to') ||
          event.target.closest('.wl-add-to-single') ||
          event.target.closest('.wl-button-wrap')
        )) {
          return;
        }
