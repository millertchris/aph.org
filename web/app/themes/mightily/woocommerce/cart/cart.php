	...
	<div class="layout list-of-items my-cart list-view">
		<div class="wrapper">
			...
			<div class="layout-options">
				<form>
					<button class="clear-button btn" name="empty_cart" value="yes">Clear Cart</button>
				</form>
				<button class="layout-button list-view btn active" data-view="list">List View</button>
				<button class="layout-button btn" data-view="grid">Grid View</button>
			</div>
							...
							if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
								...
								<div id="product-<?php echo $i; ?>" class="item woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
										<div class="item-image">
											<img src="<?php echo get_product_image_data($_product, 'url'); ?>" alt="<?php echo get_product_image_data($_product, 'alt'); ?>" />
										</div>
									...
									<div class="item-detail item-remove">
										<?php
											...
											echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
												'<a role="button" href="%s" class="edit-item" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="fas fa-times" aria-hidden="true"></i> Delete product</a>',
