    ...
    <ul class="list-items <?php echo $post_type; ?>-items">
        ...
        <li class="item <?php echo $post_type; ?>-item">
          ...
          <?php
            ...
            $state_rep = trim(get_field('state_represented'));
          ...
          <?php endif; ?>
          <div class="right">
				<?php if ($state_rep != $prev_state): ?>
					<<?php echo $listing_heading_tag; ?> class="title h3" style="background-color: #ddd;"><?php echo $state_rep; ?></<?php echo $listing_heading_tag; ?>>
                <?php endif; 
				$prev_state = $state_rep == $prev_state ? $prev_state : $state_rep;
				?>

            <div class="people-info">
              <div class="people-name">
                <p class="state-rep"><?php the_title(); ?></p>
              ...
              <?php if ($phone || $fax || $email) : ?>
                ...
                <?php if ($phone) : ?>
                  <p class="phone"><i class="fas fa-phone" aria-hidden="true"></i> Phone: <?php echo $phone; ?></p>
                <?php endif; ?>
                <?php if ($fax) : ?>
                  <p class="fax"><i class="fas fa-fax" aria-hidden="true"></i> Fax: <?php echo $fax; ?></p>
                <?php endif; ?>
                <?php if ($email) : ?>
                  <p class="email"><i class="fas fa-envelope" aria-hidden="true"></i> Email: <?php echo $email; ?></p>
                <?php endif; ?>
              </div>
            <?php endif; ?>
            </div>
            ...
            <a href="<?php the_permalink(); ?>" class="list-item-link">
              ...
              <div>
                <<?php echo $listing_heading_tag; ?> class="title"><?php the_title(); ?></<?php echo $listing_heading_tag; ?>>

                <?php if (($post_type == 'event') && have_rows("occurrences")) : ?>
