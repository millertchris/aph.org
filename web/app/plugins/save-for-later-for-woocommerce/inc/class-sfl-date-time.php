...
if ( ! class_exists( 'SFL_Date_Time' ) ) {
	...
	class SFL_Date_Time {
		 ...
		 * @param Boolean $tz Timezone
		 * @param Boolean $utc Universal Time Coordinates
		 */
		 ...
		 * @since 1.0
		 * @param Object  $date Date Object.
		 * @param Boolean $wp_zone WordPress Timezone.
		 * @return Object
		 */
		 ...
		 * @since 1.0
		 * @param Object  $date Date Object.
		 * @param Boolean $format Date time Format.
		 * @param Boolean $wp_zone WordPress Timezone.
		 */
