...
class SearchWP_Metrics_i18n {
	...
	public function load_translations() {
		...
		$this->strings = [
			...
			'deleting_metrics_data'                   => esc_html__( 'Deleting Metrics data', 'searchwp-metrics' ),
			/* Translators: %s is the number of days to delete. */
			'deleting_metrics_data_older_than'        => esc_html__( 'Deleting Metrics data older than %s', 'searchwp-metrics' ),
			'processing_table'                        => esc_html__( 'Processing table...', 'searchwp-metrics' ),
			'deletion_canceled'                       => esc_html__( 'Deletion canceled', 'searchwp-metrics' ),
			'deletion_complete'                       => esc_html__( 'Deletion complete', 'searchwp-metrics' ),
			'click_buoy'                              => esc_html__( 'Click Buoy', 'searchwp-metrics' ),
			'queries'                                 => esc_html__( 'Queries', 'searchwp-metrics' ),
			'ids'                                     => esc_html__( 'IDs', 'searchwp-metrics' ),
			'deletion_job_failed'                     => esc_html__( 'Deletion Job Interrupted', 'searchwp-metrics' ),
			'deletion_job_failed_message'             => esc_html__( 'The deletion job was interrupted. You can try to resume the job or cancel it.', 'searchwp-metrics' ),
			/* Translators: %s is the number of days to delete. */
			'deletion_job_failed_message_manual'      => esc_html__( 'The deletion job for data older than %s was interrupted. You can try to resume the job or cancel it.', 'searchwp-metrics' ),
			/* Translators: %s is the number of days to delete. */
			'deletion_job_failed_message_automatic_interval' => esc_html__( 'The automatic deletion job for data older than %s was interrupted. You can try to resume the job or cancel it.', 'searchwp-metrics' ),
			'day'                                     => esc_html__( 'day', 'searchwp-metrics' ),
			'days'                                    => esc_html__( 'days', 'searchwp-metrics' ),
			'week'                                    => esc_html__( 'week', 'searchwp-metrics' ),
			'weeks'                                   => esc_html__( 'weeks', 'searchwp-metrics' ),
			'month'                                   => esc_html__( 'month', 'searchwp-metrics' ),
			'months'                                  => esc_html__( 'months', 'searchwp-metrics' ),
			'year'                                    => esc_html__( 'year', 'searchwp-metrics' ),
			'years'                                   => esc_html__( 'years', 'searchwp-metrics' ),
			'restart_job'                             => esc_html__( 'Resume Job', 'searchwp-metrics' ),
			'cancel_job'                              => esc_html__( 'Cancel Job', 'searchwp-metrics' ),
			'stop'                                    => esc_html__( 'Stop', 'searchwp-metrics' ),
			'job_queued'                              => esc_html__( 'Job queued...', 'searchwp-metrics' ),
			'job_preparing'                           => esc_html__( 'Preparing deletion job...', 'searchwp-metrics' ),
			'preparing_table_counts'                  => esc_html__( 'Counting records in', 'searchwp-metrics' ),
			/* Translators: %s is the number of deletion jobs in the queue. */
			'jobs_in_queue'                           => esc_html__( '%d jobs in queue', 'searchwp-metrics' ),
			'entries_deleted'                         => esc_html__( 'total entries deleted', 'searchwp-metrics' ),
			'automatically_started'                   => esc_html__( 'Automatically started', 'searchwp-metrics' ),
			'manually_started'                        => esc_html__( 'Manually started', 'searchwp-metrics' ),
			'deletion_job_complete_message'           => esc_html__( 'The deletion job has completed successfully.', 'searchwp-metrics' ),
			'api_error_heading'                       => esc_html__( 'Error Loading Data', 'searchwp-metrics' ),
			'api_error_message'                       => esc_html__( 'There was a problem retrieving the data. Please try again.', 'searchwp-metrics' ),
			'api_error_timeout'                       => esc_html__( 'The request timed out. Please check your internet connection and try again.', 'searchwp-metrics' ),
			'api_error_server_heading'                => esc_html__( 'Server Error', 'searchwp-metrics' ),
			'api_error_server_message'                => esc_html__( 'There was a server error while retrieving the data. Please try again. If the problem persists, please consider clearing some of the Metrics data using the options in the main Metrics menu.', 'searchwp-metrics' ),
		];
