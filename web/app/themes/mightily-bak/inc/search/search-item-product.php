...
<div id="post-<?php the_ID(); ?>" class="item <?php echo $post_type; ?>">
    ...
    <h2 class="title h6">
        <a href="<?php the_permalink(); ?>">
            ...
            <div class="item-search-thumb" style="background-image: url(<?php echo get_product_image_url($product); ?>);"></div>
        </a>
    </h2>
    <?php if(get_field('subtitle', $id)) : ?>
        <h3 class="subtitle h6"><?php the_field('subtitle', $id); ?></h3>
    <?php endif; ?>
    <?php if(get_field('variance', $id)) : ?>
        <h4 class="subtitle h6"><?php the_field('variance', $id); ?></h3>
    <?php endif; ?>    
