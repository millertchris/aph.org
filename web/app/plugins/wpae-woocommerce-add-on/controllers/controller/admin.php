...
abstract class PMWE_Controller_Admin extends PMWE_Controller {
	...
	public function __construct() {
		...
		wp_enqueue_style('pmwe-admin-style', PMWE_ROOT_URL . '/static/css/admin.css', array(), PMWE_VERSION);

		wp_enqueue_script('pmwe-script', PMWE_ROOT_URL . '/static/js/pmwe.js', array('jquery'), PMWE_VERSION);
		wp_enqueue_script('pmwe-admin-script', PMWE_ROOT_URL . '/static/js/admin.js', array('jquery', 'pmxi-admin-script'), PMWE_VERSION);
