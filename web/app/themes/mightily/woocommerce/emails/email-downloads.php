					...
					if ( has_action( 'woocommerce_email_downloads_column_' . $column_id ) ) {
						...
						switch ( $column_id ) {
							...
							case 'download-file':
								...
								$file_url = (isset($email) && $email->id == 'secondary_louis_download') ? $download['file']['file'] : $download['download_url'];
								?>
								<a href="<?php echo esc_url( $file_url ); ?>" class="woocommerce-MyAccount-downloads-file button alt"><?php echo esc_html( $download['download_name'] ); ?></a>
                                <?php
								break;
