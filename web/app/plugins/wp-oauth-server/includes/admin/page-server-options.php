                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input type="number" name="wo_options[token_length]" min="10" max="255"
                                               value="<?php echo sanitize_text_field( $options['token_length'] ); ?>"
                                               placeholder="40"/>
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input type="number" name="wo_options[id_token_lifetime]"
                                               value="<?php echo sanitize_text_field( $options['id_token_lifetime'] ); ?>"
                                               placeholder="3600"/>
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input type="number" name="wo_options[access_token_lifetime]"
                                               value="<?php echo sanitize_text_field( $options['access_token_lifetime'] ); ?>"
                                               placeholder="3600"/>
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input type="number" name="wo_options[refresh_token_lifetime]"
                                               value="<?php echo sanitize_text_field( $options['refresh_token_lifetime'] ); ?>"
                                               placeholder="86400"/>
