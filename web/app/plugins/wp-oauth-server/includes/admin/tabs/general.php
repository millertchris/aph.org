...
?>
<p>
	You can visit your site Health Dashboard for more debug information by visiting <a
			href="<?php echo admin_url( 'site-health.php?tab=debug' ); ?>"><?php echo admin_url( 'site-health.php?tab=debug' ); ?></a>
</p>
<table class="form-table">
	<tr>
		...
		<td>
			...
			<?php
			if ( is_multisite() ) {
				echo '| Warning. Multisite Detected';
			};
			?>
		</td>
	</tr>
