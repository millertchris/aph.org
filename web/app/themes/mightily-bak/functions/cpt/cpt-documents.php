<?php
    ...
    function documents() {
        ...
        $args = [
            ...
            'description'           => __('A collection of documents.', 'text_domain'),
            'labels'                => $labels,
            'supports'              => [ 'title' ],
            'taxonomies'            => [ 'document_types' ],
            'hierarchical'          => false,
            'public'                => true,
            'show_ui'               => true,
            'show_in_menu'          => true,
    ...
    function document_types() {
        ...
        register_taxonomy('document_types', [ 'documents' ], $args);
    }
    add_action('init', 'document_types', 0);
