                    ...
                    <tr class="cart_table_item">
                        <td class="product-name">
                            ...
                            <div class="row-actions">
									<span class="edit">
										<small><a role="button" rel="nofollow" href="<?php $list->the_url_edit(); ?>"><?php _e( 'Manage this list', 'wc_wishlist' ); ?></a></small>
									</span>
                                |
                                <span class="trash">
										<small><a role="button" rel="nofollow" class="ico-delete wlconfirm" data-message="<?php _e( 'Are you sure you want to delete this list?', 'wc_wishlist' ); ?>" href="<?php $list->the_url_delete(); ?>"><?php _e( 'Delete', 'wc_wishlist' ); ?></a></small>
									</span>
