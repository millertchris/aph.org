...
= 3.3.5 =
Security fix: REST API endpoints now require authentication by default (CVE-2025-62979)
Options endpoints require manage_options capability
User endpoints have proper capability checks
Added ACF_TO_REST_API_ALLOW_PUBLIC_ACCESS constant for backward compatibility
