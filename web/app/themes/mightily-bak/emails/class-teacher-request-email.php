...
class Teacher_Request_Email extends WC_Email
{
    ...
    public function __construct()
    {
        ...
        $this->id = 'teacher_request_email';

        // Is a customer email
        $this->customer_email = false;

        // Title field in WooCommerce Email settings
        $this->title = __('Teacher Request Email', 'woocommerce');

        // Description field in WooCommerce email settings
        $this->description = __('This email is sent to a Teacher when a new order is placed with the EOT payment gateway.', 'woocommerce');

        // Default heading and subject lines in WooCommerce email settings
        $this->subject = apply_filters('teacher_request_email_default_subject', __('New Request Submitted', 'woocommerce'));
        $this->heading = apply_filters('teacher_request_email_default_heading', __('Your request has been submitted to your EOT.', 'woocommerce'));
        ...
        $this->template_html  = 'teacher-request-email.php';
        $this->template_plain = 'plain-teacher-request-email.php';

        $this->eot_user_id = false;
     ...
     * @param int $order_id
     */
    public function trigger($order_id, $recipient_email, $eot_user_id)
    {
