...
class WPOAuth_Admin {
	...
	protected $mapping_option_name = 'wp_oauth_server_mapping_settings';
	...
	public function admin_init() {
		...
		register_setting( 'wp_oauth_server_mapping_settings_group', $this->mapping_option_name );
		...
		include_once dirname( __FILE__ ) . '/admin/setting-page-mapping.php';
	}
	...
	public function add_page() {
		...
		add_submenu_page( 'wo_manage_clients', 'Mapping', __( 'Mapping', 'wp-oauth' ), 'manage_options', 'wo_server_mapping', 'wo_server_mapping_options_page' );
