...
<div class="interior-page">
	...
	<?php if(isset($_GET['invite_success']) && $_GET['invite_success']) : ?>
		<div class="wrapper" style="padding-top: 50px;">
			<?php wc_print_notice( esc_html__( 'Your shopper account has been activated successfully.', 'woocommerce'), 'notice' ); ?>
		</div>
	<?php endif; ?>
