...
var jsFiles = ['src/js/scripts.js', 'src/js/admin-scripts.js', 'src/js/validatePo.js', 'src/js/inviteShopper.js', 'src/js/manageAddresses.js', 'src/js/orderStatus.js', 'src/js/checkFqBalance.js', 'src/js/checkNetBalance.js'],
