		...
		<div class="wrapper">
			...
			<div class="line-items">
				...
				<div id="order-<?php echo $i; ?>" class="item">
					...
					<div class="item-detail"><p>Quantity: <span class="item-span"><?php echo $order->get_item_count(); ?></span></p></div>

					<div class="item-detail"><p>Status: <span class="item-span"><?php echo esc_html( wc_get_order_status_name( $order->get_status() ) ); ?></span></p></div>
					<div class="item-detail"><p><?php echo $orderText; ?> Total: <span class="item-span">$<?php echo $order->get_total(); ?></span></p></div>
