<?php
/**
 * 360° Image for WooCommerce Admin.
 *
 * @since 1.3.0
 */
...
class Admin {
	...
	public static function action_links( $links ) {
		$settings_link = sprintf(
			...
			_x( 'View 360° Image for WooCommerce settings', 'aria-label: settings link', 'woocommerce-360-image' ),
	...
	public static function plugin_row_meta( $links, $file ) {
		...
		$links['docs'] = sprintf(
			...
			esc_attr_x( 'View 360° Image for WooCommerce documentation', 'aria-label: documentation link', 'woocommerce-360-image' ),
