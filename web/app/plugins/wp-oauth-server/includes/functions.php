...
function wo_is_licensed() {
	...
	if ( $options !== false && isset( $options['license'] ) ) {
 ...
 * The header authorization takes presidence abut if it is not present but the url contains a token, return it.
 *
 * @param $server
 *
 * @return mixed|string|null
 */
function wp_oauth_get_authentication_token( $server ) {
	 /*
