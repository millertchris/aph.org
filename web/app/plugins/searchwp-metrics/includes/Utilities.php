...
class Utilities {
	...
	public function update_settings() {
		...
		$view_background_process = isset( $_REQUEST['view_background_process'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['view_background_process'] ) ) : false;
		...
		$metrics->save_boolean_option( 'view_background_process', $view_background_process );
	...
	public function update_logging_rules() {
		...
		$ips   = isset( $_REQUEST['ips'] ) ? trim( sanitize_textarea_field( wp_unslash( $_REQUEST['ips'] ) ) ) : '';
