...
class ASPWC_Admin {
	...
	public function enqueue_scripts( $hook ) {
		...
		if (
			( isset( $_REQUEST['post'] ) && 'shipping_package' == get_post_type( wc_clean( $_REQUEST['post'] ) ) ) ||
 ...
 */
require_once plugin_dir_path( __FILE__ ) . './class-aspwc-condition.php';
require_once plugin_dir_path( __FILE__ ) . './class-aspwc-product-condition.php';
