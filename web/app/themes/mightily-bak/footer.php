    ...
    <div class="main-footer">
        <div class="wrapper">
            ...
            <div class="logo-social">
                ...
                <a target="_blank" class="mightily-logo mightily-home" href="https://mightily.com/"><img class="logo mightily" src="<?php echo $template_url; ?>/app/assets/img/Mightily.jpg" alt="Mightily Home Page Link"></a>
