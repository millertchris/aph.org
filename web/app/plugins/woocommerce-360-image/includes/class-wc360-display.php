<?php
/**
 * 360° Image for WooCommerce Display
 *
...
if ( ! class_exists( 'WC_360_Image_Display' ) ) {
	...
	class WC_360_Image_Display {
		...
		public function display_bool() {
			...
			if ( $product && get_post_meta( $product->get_id(), 'wc360_enable', true ) !== 'yes' ) {
				return false;
			}

			$attachment_ids = $product ? WC_360_Image_Utils::get_gallery_ids( $product ) : array();
		...
		public function output_image() {
			...
			// phpcs:ignore
			echo apply_filters( 'wc360_image_output', $content ); // nosemgrep
		 ...
		 *
		 * @package 360° Image for WooCommerce
