<?php
    ...
    add_action('woocommerce_proceed_to_checkout', function() { \APH\Products::removeIneligibleItemsFromCart(false);});

    // APH-493 Also run it on the cart page for consistency, and let people know we are removing items.
    add_action('woocommerce_before_cart', function() { \APH\Products::removeIneligibleItemsFromCart(true);});
