                ...
                switch ($options['cc_options'][$elId]) {
                    ...
                    case 'fees':
                        ...
                        if ($options['cc_value'][$elId] == '_cart_discount') {
                            ...
                            // Use wc_format_decimal to preserve precision for total discount amount
                            $discount_value = is_numeric($_cart_discount) ? $_cart_discount : 0;
                            $data[$options['cc_name'][$elId]] = pmxe_filter(wc_format_decimal($discount_value * (-1), false), $fieldSnipped);
                        }
