...
/* translators: %s: Singular post type name */
$twitter_description = esc_html__( 'X Cards support enhances how your content appears when shared on X. You can set default values here but also customize this per %s via the post editor.', 'wds' );
