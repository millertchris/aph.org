			...
			<?php foreach ( $lists as $list ) : ?>
                ...
                <tr class="cart_table_item">
                    ...
                    <td class="wl-delete-col">
                        ...
                        ?>
                        <a class="btn wlconfirm" data-message="<?php _e( 'Are you sure you want to delete this list?', 'wc_wishlist' ); ?>" href="?<?php echo http_build_query($delete_query); ?>"><?php _e( 'Delete List', 'wc_wishlist' ); ?></a>
                    </td>
                </tr>
