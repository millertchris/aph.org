...
function custom_override_checkout_fields($fields) {
    if (is_user_role('teacher')) {
        ...
        $fields['order']['order_comments']['placeholder'] = 'Notes for your own records only. For specific delivery instructions, please contact Customer Service. Please do not include student personal identifiable information.';
...
function woo_add_continue_shopping_button_to_cart() {
    ...
    echo '<a role="button" href="/shop" class="continue-shopping-button button">Continue Shopping</a>';
    echo '</div>';
}
...
function aph_item_thumb() { global $post;
  ?>
            <a href="<?php the_permalink(); ?>">
                <div class="item-image">
                    <img src="<?php echo get_product_image_data($post, 'url'); ?>" alt="<?php echo get_product_image_data($post, 'alt'); ?>" />
                </div>
...
function custom_woocommerce_emails($email_classes) {
    ...
    include(locate_template('emails/class-secondary-louis-download-email.php'));
    ...
    $email_classes['Secondary_Louis_Download_Email'] = new Secondary_Louis_Download_Email();
