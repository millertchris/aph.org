...
elseif ( 'pending' === $order->get_status() && ! WC_Pre_Orders_Manager::is_zero_cost_order( $order ) && WC_Pre_Orders_Order::order_has_payment_token( $order ) ) :

	esc_html_e( 'Your pre-order is now available. Your payment is being processed automatically and you will receive a confirmation once the payment is complete.', 'woocommerce-pre-orders' );
	echo "\n\n";
